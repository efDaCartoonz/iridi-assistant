...
Этот запуск использует режим `рабочий чат`: обращения поступают как HTML/PDF-вложения, а дополнительные логи, проекты, конфигурации, изображения и другие материалы могут быть приложены отдельно.
